...
def group_data_set(ds: xarray.Dataset, *args, group_dim:str = 'time',**kwargs) -> xarray.Dataset:
    ...
    my_logger.info(f"Grouping over {group_dim} with args: {args} & kwargs: {kwargs} for time: {time_str} ")
    result = dict()
...
if __name__ == '__main__':
    ...
    parser.add_argument('output_file', type=pathlib.Path, help='name of output file')
