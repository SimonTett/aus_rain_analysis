# plot GSDR stns with in 150 km of the Melbourne radar.
...
radar_stn_name='Sydney'
radar_stn_id = 3
ds = xarray.open_dataset(ausLib.radar_dir/f"{radar_stn_id}/RAINRATE/{radar_stn_id}_20000923_rainrate.nc")
...
fig = plt.figure(clear=True, num=f'AU_GSDR_{radar_stn_name}', figsize=(8, 5), layout='constrained')
...
ax.set_title(f"GSDR {radar_stn_name} Stations 2000-2015")
ax.coastlines()
ax.add_feature(states)
fig.show()
fig.savefig(f"AU_GSDR_{radar_stn_name}.png")
