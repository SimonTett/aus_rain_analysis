...
for site in ausLib.site_numbers.keys():
    ...
    datasets[site] = xarray.open_dataset(event_file)  # median extreme event
...
for site, ax in axes.items():
    sample_resolution = datasets[site].sample_resolution.load()
